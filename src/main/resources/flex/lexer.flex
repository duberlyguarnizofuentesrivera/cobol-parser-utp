package edu.utp.cobolparserutp;
...
%{
	...
	public static Map<String, String> tablaSimbolos = new TreeMap<>();
      private List<String> tokenList = new ArrayList<>();
      private List<String> identifiersList = new ArrayList<>();
    ...
    public void toString(String Token) {
      tokenList.add(Token + " | " +yytext());
      if(Token == "TOK_IDENTIFIER"){
        identifiersList.add(Token + " | " +yytext());
      }
	}
